...
System.out.println("Intelligent ANC puts your playlist in focus. With 3 high SNR (Signal-to-Noise Ratio) microphones, Galaxy Buds2 Pro track and eliminate more outside sound — even soft sounds like wind. Switching to in-person conversations is easy with Voice Detect."); 
System.out.println("Simply start talking and Voice Detect will turn off ANC and activate Ambient sound — allowing you to clearly hear the conversation without removing your Buds2 Pro");
}
}